...
class EvaluationConfig(Dict):
    def __init__(self):
        ...
        self.num_scenes_to_evaluate = 40
        self.nusc.eval_scenes = np.arange(80,120).tolist()#[17,18]#[4,17]#[87,97,99] #2,6,17]#np.arange(100).tolist() # where scene choice is made
        # Same Lane Index = [4,17]
        # Intersection Indices = [0,26,41,53,76,82,87,97,99]
        self.suffix = "pleasework2_80_120_30u_5step_2speedup"
